...
<body style="font-family: poppins; background-color:#F7F7F7; height:100%" id="body">
    ...
    <footer class="py-3" style="background-color: rgb(255, 255, 255);">
        <p class="text-center text-muted mt-3">&copy; <?php echo date('Y'); ?> We Care | Repost by <a href='https://github.com/novalbahri17' title='Github.com' target='_blank'>github.com</a>
        </p>
    </footer>
